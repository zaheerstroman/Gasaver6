    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.layout_terms:
                ...
                intent.putExtra("Attachment", SharedPrefs.getInstance(this).getString(Constants.TC_base_path) + SharedPrefs.getInstance(this).getString(Constants.termsAndConditions));

                startActivity(intent);
                break;
            case R.id.layout_privacy:
                intent = new Intent(this, PrivacyPolicyActivity.class);
                intent.putExtra("Attachment", SharedPrefs.getInstance(this).getString(Constants.TC_base_path) + SharedPrefs.getInstance(this).getString(Constants.privacyPolicy));
